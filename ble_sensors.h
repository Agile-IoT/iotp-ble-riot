...
/* UUIDs for OTP service, generated from https://uuidgenerator.org */

#define OTP_SERV_UUID 0x44, 0xF0, 0x01, 0xCD, 0x24, 0xDA, 0x5A, 0xB4, \
0xE8, 0x11, 0x50, 0x78, 0x5C, 0x94, 0x91, 0x84

#define OTP_DATA_UUID 0x44, 0xF0, 0x01, 0xCD, 0x24, 0xDA, 0x5A, 0xB4, \
0xE8, 0x11, 0x50, 0x78, 0x5D, 0x94, 0x91, 0x84

#define OTP_CONF_UUID 0x44, 0xF0, 0x01, 0xCD, 0x24, 0xDA, 0x5A, 0xB4, \
0xE8, 0x11, 0x50, 0x78, 0x5E, 0x94, 0x91, 0x84
...
static const ble_uuid128_t gatt_svr_chr_otp_serv_uuid =
        BLE_UUID128_INIT(OTP_SERV_UUID);

static const ble_uuid128_t gatt_svr_chr_otp_data_uuid =
        BLE_UUID128_INIT(OTP_DATA_UUID);

static const ble_uuid128_t gatt_svr_chr_otp_conf_uuid =
        BLE_UUID128_INIT(OTP_CONF_UUID);
